...
exports['file'] = {
  ...
  'write': function(test) {
    ...
    grunt.file.write(tmpfile.path, octocat, {encoding: null});
    test.ok(compareBuffers(fs.readFileSync(tmpfile.path), octocat), 'buffer should be written as binary data if encoding is specified as null.');
    tmpfile.unlinkSync();
